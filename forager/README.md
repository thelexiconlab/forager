...
- Similarity Drop (switch_simdrop)
- Norms-based Associative (switch_norms_associative)
- Norms-based Categorical (switch_norms_categorical)
- Multimodal Similarity Drop (switch_multimodal)
- Delta Similarity (switch_delta)
- Multimodal Delta (switch_multimodaldelta)
- Slope Difference (switch_slope_difference)
- Probabilistic Evidence Integration / PEI (switch_pei)
