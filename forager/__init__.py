...
normspath =  pkg_path + '/data/norms/animals_snafu_scheme_vocab.csv'
similaritypath =  pkg_path + '/data/lexical_data/USE_semantic_matrix.csv'
frequencypath =  pkg_path + '/data/lexical_data/USE_frequencies.csv'
phonpath = pkg_path + '/data/lexical_data/USE_phonological_matrix.csv'
vocabpath = pkg_path + '/data/lexical_data/vocab.csv'
