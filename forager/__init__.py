...
from .switch import switch_delta, switch_multimodal, switch_simdrop, switch_troyer
...
phonpath = pkg_path + '/data/lexical_data/phonmatrix.csv'
...
# Example:
# data = retrieve_data('data-psyrev.txt')
# run_model(data, 'dynamic', 'all', 'sample')
#